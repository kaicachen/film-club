    ...
    <div className="flex w-full flex-col md:col-span-4">
      <div className="flex grow flex-col justify-between rounded-xl bg-gray-50 p-4">
        <div className="relative overflow-y-auto max-h-[70vh] rounded-md border border-gray-200 bg-white">
          <div className="top-0 z-10 grid grid-cols-[2fr_1fr_1fr_1fr_1fr] gap-4 bg-gray-100 text-gray-700 font-semibold px-6 py-2 text-sm md:text-base border-b border-gray-300 shadow-sm">
            <div>Film</div>
            <div>Director</div>
            <div>Year Released</div>
            <div>Date Discussed</div>
            <div>Like Percentage</div>
          </div>

          <div className="divide-y divide-gray-200">
            {likeDislikeFilm.map((film) => (
              <div
                key={film.film_id}
